V4nder.TableContainsItem = function (items, table, ignoreCase)
    items = items or {}
    table = table or {}
...
V4nder.PrintToUser = function(message)
    print(Ansicolors(message))
end

V4nder.PrintToConsole = function(message)
    print(AnsiConsole(message))
end

V4nder.RandomString = function(length)
    local result = ''
